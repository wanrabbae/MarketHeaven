        ...
        <>
            <div className="flex h-screen justify-center content-center w-screen">
                <div className='hidden flex-1 md:flex md:justify-center md:items-center'>
                    <img src="https://cdn.discordapp.com/attachments/1008921423915532368/1103525521373024256/markus-winkler-PQmXUxmfR44-unsplash.jpg" alt="WEB SHOP" className='w-screen h-screen' />
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        autoComplete="email"
                                        required
                                        className="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 p-2"
                                    />
                                </div>
                            </div>
